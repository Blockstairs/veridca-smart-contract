...
This contract is used to register and verify the ownership of digital assets.

*This contract is based on the EIP721.*
...
| Name | Type | Description |
|---|---|---|
| _0 | uint256 | uint256 The next id to be minted. |
...
*Return if the tokenId exists or not.*
...
```solidity
function initialize(address owner, string name, string symbol) external nonpayable
```

This function is used to initialize the contract.

*This function is based on the OpenZeppelin implementation of the Initializable standard and can only be called once*

#### Parameters

| Name | Type | Description |
|---|---|---|
| owner | address | The address of the owner/admin of the contract |
...
This function is used to mint a new token with a URI.

*This function uses ERC721._safeMint() to mint the token. Requirements: - The sender must have `MINTER_ROLE`.*

#### Parameters

| Name | Type | Description |
|---|---|---|
| to | address | The address of the new owner of the token |
...
| Name | Type | Description |
|---|---|---|
| _0 | uint256 | uint256 The first id to be minted. |
...
| Name | Type | Description |
|---|---|---|
| _0 | uint256 | uint256 representing the total amount of tokens burned |
...
| Name | Type | Description |
|---|---|---|
| _0 | uint256 | uint256 representing the total amount of tokens minted |
